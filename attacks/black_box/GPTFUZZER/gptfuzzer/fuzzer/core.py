...
class GPTFuzzer:
    ...
    def run(self):
        ...
        # self.raw_fp.close()
        return self.model_calls_count,self.successful_prompts
    ...
    def evaluate(self, prompt_nodes: 'list[PromptNode]'):
        for prompt_node in prompt_nodes:
            ...
            prompt_node.full_prompts = full_prompts
    ...
    def update(self, prompt_nodes: 'list[PromptNode]'):
        ...
        for prompt_node in prompt_nodes:
            if prompt_node.num_jailbreak > 0:
                self.successful_prompts.extend(prompt_node.full_prompts)
