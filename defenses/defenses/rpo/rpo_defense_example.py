...
from dependencies.opt_utils import load_model_and_tokenizer, get_filtered_cands
import wandb
import pandas as pd
import torch
import logging
...
def get_goals_and_targets(train_data_path='./data/harmful_behaviors.csv',
                          test_data_path=None,
                          n_train_data='1',
                          n_test_data='25',
                          data_offset=0,
...
train_goals, train_targets, test_goals, test_targets = get_goals_and_targets(
    train_data_path='./data/harmful_behaviors.csv',
    n_train_data=25,
    n_test_data=25,
    train_data_available=True
)
...
def main():
    ...
    for goal, target in zip(test_goals, test_targets):
        ...
        for prompt in prompts:
            ...
            output = model.generate(input_ids, attention_mask=attn_masks, generation_config=gen_config,
        ...
        idx += 1
        print(f"Evaluated {idx}/{total_evaluations} examples")
